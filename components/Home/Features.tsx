      ...
      <div className="grid grid-cols-2 gap-12 mt-6"  data-aos="fade-right">
        ...
        <div className="col-span-2 lg:col-span-1" >
           {homefeatures.map((feature, index) => (
             <div key={index} className="flex gap-5 my-4 items-start"  data-aos="fade-left">
                <div className="rounded-full p-2" style={{border: `2px solid ${feature.color}`}}>
                <Image src={feature.image} alt="features" width={110} className="p-4 rounded-full " style={{backgroundColor: feature.color}}/>
                </div>
               <div>
